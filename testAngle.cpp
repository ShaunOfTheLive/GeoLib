int testAngle()
{
  ...
  cout << deg1 << " deg + " << deg2 << " deg = " << a1_p_a2.get(Angle::Degrees) << endl;
  ...
  cout << deg2 << " deg += " << deg1 << " deg: " << a2_pe_a1.get(Angle::Degrees) << endl;
  if (passed) {
  ...
  cout << rad2 << " rad += " << rad1 << " rad = " << a5_pe_a4.get(Angle::Radians) << endl;
  if (passed) {
